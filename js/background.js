...
var appConfig = {"hostname":"messages.android.com","userAgent":"","behavior":{"internalLinks":false},"chromeAppWindow":{"id":"embed","frame":"none","innerBounds":{"width":1180,"height":900}}};
/**
        ...
        win.contentWindow.onload = function () {
            ...
            webview.addEventListener('newwindow', function (e) {
                ...
                // Open app links internally?
                    ...
                    return chrome.app.window.create(
                        'html/embed.html',
                        { frame: { type: 'chrome' }, innerBounds: appConfig.chromeAppWindow.innerBounds }, onWindowLoaded(e));
                }
